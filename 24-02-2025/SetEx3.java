...
public class SetEx3 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("TreeSet does not accepts null value");
       ...
       // st.retainAll(st1);
        ...
        try {
        	...
        	System.out.println("TreeSet Cannot take null values");
        }
        Set<String> st4=new LinkedHashSet<>();
        st4.add("Ria");
        st4.add("Ramesh");
        System.out.println("st4.retainAll(st2) : "+st4.retainAll(st2));
        //st2.add(null);
        Set<String> st3=new TreeSet<>();
        st3.add("Kiran");
		st3.add("Martinelli");
		st3.add("Kajol");
		System.out.println("Elements of st3 : "+st3);
        System.out.println("Retain with mismatch : "+st3.retainAll(st));
	}
